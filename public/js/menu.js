const barraHTML = `
  ...
  <nav class="barra-navegacion">
    <div class="logo-menu">
      <button id="btn-menu-toggle" class="menu-toggle-btn" aria-label="Menú">
  ...
  <div class="menu-panel" id="menu-panel">
    <div class="menu-panel-header">
      <img src="/img/logo2.png?v=${window.WIND_CACHE_VERSION || Date.now()}" alt="Wind">
      <button id="btn-menu-cerrar" class="menu-cerrar-btn" aria-label="Cerrar menú">
...
function insertarBarra() {
  ...
  const closeBtn = document.getElementById('btn-menu-cerrar');
